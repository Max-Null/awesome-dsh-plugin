...
- [Max-Null/dsh-chat-rail](https://github.com/Max-Null/dsh-chat-rail) — 右侧竖条消息导航栏：scroll-spy 跟随阅读位置，hover 展开画卷式预览，点击跳转任意历史消息。
- [Max-Null/dsh-node-appearance](https://github.com/Max-Null/dsh-node-appearance) — 按节点类型/工具名给会话节点着色（可配置配色），附带思考过程显示开关。
